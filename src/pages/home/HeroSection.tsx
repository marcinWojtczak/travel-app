...
export default function HeroSection() {
  return (
    <>
    <div className='flex bg-fixed bg-parallax flex-col justify-center h-[650px] lg:h-screen gap-1 px-6 md:px-7 xl:px-10 2xl:px-[116px] bg-cover bg-center rounded-b-2xl'>
      <Header />
